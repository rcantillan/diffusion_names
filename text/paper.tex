...
\begin{figure}[H]
\begin{center}
    \includegraphics[width=20cm]{plot/tipo_nombre_nuevo.png}
    \caption{Nombres nuevos por quintil}
    \label{fig:tipo_nombre_nuevo}
\end{center}
\end{figure}
\end{landscape}
...
\begin{figure}[H]
\begin{center}
    \includegraphics[width=20cm]{plot/tipo_nombre_reciclado.png}
    \caption{Nombres nuevos por quintil}
    \label{fig:tipo_nombre_reciclado}
\end{center}
\end{figure}
\end{landscape}
